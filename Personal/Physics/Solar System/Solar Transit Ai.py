...
celestials = [Body(1.496*(10**11),0,Earth.get_rect(center = (0,0)),Earth,6*(10**24),(0,29846),6.4*(10**6)),Body(1.496*(10**11) + 384000000,0,Luna.get_rect(center = (0,0)),Luna,7.34*(10**22),(0,1056+29846),1.74*(10**6)),Body(0,0,Sol.get_rect(center = (0,0)),Sol,1.989*(10**30),(0,0),6.95*(10**8))]
celestials_minor = [Body(5.8*10**10,0,Mercury.get_rect(center = (0,0)),Mercury,3.3*10**23,(0,47900),2.43*10**6),Body(108*10**9,0,Venus.get_rect(center = (0,0)),Venus,4.87*10**24,(0,35000),6.05*10**6),Body(228*10**9,0,Mars.get_rect(center = (0,0)),Mars,0.642*10**24,(0,24100),(6792*10**3)/2),Body(778.5*10**9,0,Jupiter.get_rect(center = (0,0)),Jupiter,1898*10**24,(0,13100),(142984*10**3)/2),Body(1432*10**9,0,Saturn.get_rect(center = (0,0)),Saturn,568*10**24,(0,9700),(120536*10**3)/2),Body(2867*10**9,0,Uranus.get_rect(center = (0,0)),Uranus,86.8*10**24,(0,6800),(51118*10**3)/2),Body(4515*10**9,0,Neptune.get_rect(center = (0,0)),Neptune,102*10**24,(0,5400),(49528*10**3)/2),Body(5906.4*10**9,0,Pluto.get_rect(center = (0,0)),Pluto,0.013*10**24,(0,4700),(2376*10**3)/2)]
...
while True:
    ...
    #center_xdis = -celestials[7].absX
    #center_ydis = -celestials[7].absY
    for C in celestials:
        forces = []
        window_blit(C)
        if thrust:
