...
class Liquid:
    def __init__(self, topheight, density):
        ...
        self.surf.fill("Light Blue")
        self.rect = self.surf.get_rect(topleft = (0,800-topheight))
    def changeheight(self,newheight):
        self.surf = pygame.Surface((800,newheight))
        self.surf.fill("Blue")
        self.rect = self.surf.get_rect(topleft = (0,800-newheight))
    ...
    for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_w:
                    liquids = [Liquid(liquids[0].topheight+100,liquids[0].density)]
