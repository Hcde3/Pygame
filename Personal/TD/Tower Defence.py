...
while play == True:
    ...
    while pycoderun == True:
        while stage == 0:
            ...
            enemieskilled = 0
            start = []
            rounds = [begin,round1,round2,round3,round4,round5]
                                            ...
                                            if TDanimationslide[x] == pike:
                                                ...
                                                for pk in range(len(enemy)):
                                                    if TowersDownangle[x] == 90:
                                                        ...
                                                        r = 1
                                                    if pikeforward.get_rect(topleft = ((Towerscords[x][0] - (appendage.get_width()/2)*r),(Towerscords[x][1] - appendage.get_height()/2))).collidepoint((xcords[pk],ycords[pk])):  
                                                        enemyhealth[pk] -= 60
                                                        if enemyhealth[pk] <= 0:
                                                            killernum = x
                                            else:
